...
switch ($action) {
    ...
    case "classementUser": {
            ...
            $LeClassement = $pdo->getLeClassementUser();
            $_SESSION['TabClassement'] = $LeClassement;
        }


    case "DetailStatistique": {
            if (isset($_GET["idUser"])) {
                ...
                $lesDetailClassement = $pdo->getLeDetailDuClassement($idUser);
                $_SESSION['LesDetailDuClassement'] = $lesDetailClassement ;
                
                //$_SESSION['DetailClassement'] = $DetailClass
                //var_dump($DetailClass);
                include('vues/v_classementDetail.php');
            }
        }
}
?>