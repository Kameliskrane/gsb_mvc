        ...
        <table class="listeLegere">
         ...
         ?>
                <tr<?php if($_SESSION['infosHorsForfait'][$i]["Etat"]=="Refusée"){echo ' bgcolor="#FF0000" ';}?>>
                    ...
                    <td><form method="post" action="index.php?uc=gererFrais&action=supprimerFrais"><input type="hidden" value="<?php echo$i?>" name="i"><input type="submit" <?php if($_SESSION['infosHorsForfait'][$i]["Etat"]=="Refusée"){echo"disabled='disabled'";}?> value="Supprimer"/></form></td> 
